...
class ArticleTypesControllerTest < ActionController::TestCase
  ...
  test "should create article_type" do
    assert_difference('ArticleType.count') do
      post :create, article_type: { description: @article_type.description, name: @article_type.name, published: @article_type.published }
    end
  ...
  test "should update article_type" do
    put :update, id: @article_type, article_type: { description: @article_type.description, name: @article_type.name, published: @article_type.published }
    assert_redirected_to article_type_path(assigns(:article_type))
  end
